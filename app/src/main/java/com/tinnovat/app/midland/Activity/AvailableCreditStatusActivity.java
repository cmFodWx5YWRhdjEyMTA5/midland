...
public class AvailableCreditStatusActivity extends BaseActivity {
    ...
    TextView pendingDebit;
    TextView onHandBalance;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        pendingDebit = findViewById(R.id.pendingDebit);
        onHandBalance = findViewById(R.id.onHandBalance);
        availableCredit = findViewById(R.id.availableCredit);
    ...
    public void setData(Data responseData){
        ...
        pendingCredit.setText((responseData.getDataSet().get(0).get("PendingCreditApproval")));
        pendingDebit.setText((responseData.getDataSet().get(0).get("PendingRequestApproval")));
        onHandBalance.setText((responseData.getDataSet().get(0).get("OnHandBalance")));
        availableCredit.setText((responseData.getDataSet().get(0).get("AvailableCredit")));
    }
    ...
    private QueryRequestEnvelope getRequestEnvelopeGeneral() {
        ...
        FieldData fieldData = new FieldData("UserDailyActivity_ID","1000053");
        ...
        modelCRUD.setServiceType("MLW_cashUtilization_AvailCrView_View");
        modelCRUD.setTableName("mlv_cashUtilization_AvailCr_view");
