...
public class UserTaskViewActivity extends BaseActivity {
    ...
    private void initiateService() {
        ...
        call.enqueue(new Callback<ResponseQueryEnvelope>() {
            ...
            public void onFailure(Call<ResponseQueryEnvelope> call, Throwable t) {
                endLoading();
                Toast.makeText(UserTaskViewActivity.this,"Network Error",Toast.LENGTH_SHORT).show();
            }
        });
