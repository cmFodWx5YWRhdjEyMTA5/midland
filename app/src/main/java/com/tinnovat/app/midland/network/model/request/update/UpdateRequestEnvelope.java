...
public class UpdateRequestEnvelope {

    @Element(name = "soapenv:Body", required = false)
    private UpdateDataRequestBody body;

    public UpdateDataRequestBody getBody() {
        return body;
    }

    public void setBody(UpdateDataRequestBody body) {
        this.body = body;
    }
}
